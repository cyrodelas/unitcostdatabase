...
class Projects extends Authorized_Controller
{
	...
	private function handle_form($project)
	{
		...
		$this->form_validation->set_rules('project_type_id','Project type','trim|integer');$this->form_validation->set_rules('location_id','Location','trim|integer');
		...
		$this->render('projects/form',array('page_title'=>$project?'Edit Project':'Add Project','page_subtitle'=>'Project master record','project'=>$project,'project_types'=>$this->Project_model->project_types(),'locations'=>$this->Project_model->locations(),'form_error'=>$form_error,'breadcrumbs'=>array(array('label'=>'Project Master','url'=>site_url('projects')),array('label'=>$project?'Edit':'Add'))));
	}
